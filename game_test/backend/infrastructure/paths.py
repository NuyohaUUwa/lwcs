...
if __name__ == "backend.infrastructure.paths":
    sys.modules.setdefault("game_test.backend.infrastructure.paths", _CURRENT_MODULE)
elif __name__ == "game_test.backend.infrastructure.paths":
    sys.modules.setdefault("backend.infrastructure.paths", _CURRENT_MODULE)

_GAME_TEST_DIR = os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
