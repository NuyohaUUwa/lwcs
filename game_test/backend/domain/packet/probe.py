...
from game_test.core.codec import extract_utf8_segments, extract_packet_fingerprint
from game_test.backend.runtime import get_session
from game_test.backend.domain.travel.map_npc_parse import compute_map_npc_list_for_packet
from game_test.backend.infrastructure.paths import FINGERPRINTS_FILE as _FINGERPRINTS_FILE
from game_test.backend.infrastructure.packet_log_service import append_packet_record
...
_DEFAULT_FINGERPRINTS: Dict[str, str] = {
    ...
    "e80301005151": "物品信息片段",
    "e8030100d607": "背包物品列表",
    "e80301004f51": "合成结果(成功/失败/材料不足提示)",
...
def record_packet(raw_bytes_or_hex, direction: str) -> Optional[PacketRecord]:
    ...
    map_npc_list = compute_map_npc_list_for_packet(
        direction=record.direction,
        fingerprint=fingerprint,
        raw_hex=raw_hex,
    )
    record_dict["map_npc_list"] = map_npc_list if map_npc_list else None
