...
from game_test.backend.infrastructure.paths import TELEPORT_DESTINATIONS_FILE as DESTINATIONS_FILE
...
def get_teleport_destinations() -> list[dict[str, str]]:
...
def build_teleport_packet(destination: str) -> dict[str, str]:
